package com.projecttango.droneMaze; //uwb.xr.embedded_unity_drone_control
...
public class ConnectionActivity extends Activity implements View.OnClickListener {
                    ...
                    DJISDKManager.getInstance().registerApp(ConnectionActivity.this.getApplicationContext(), new DJISDKManager.SDKManagerCallback() {
                        ...
                        public void onRegister(DJIError djiError) {
                            if (djiError == DJISDKError.REGISTRATION_SUCCESS) {
                                ...
                                Log.v(TAG, "REGISTER SUCCESS: " + djiError.getDescription());
                            } else {
                                showToast("Register sdk fails, check network is available");
                                Log.v(TAG, "REGISTER FAIL: " + djiError.getDescription());
                            }
                        ...
                        public void onProductDisconnect() {
                            ...
                            notifyStatusChange();
                            Log.v(TAG,"REGISTER PRODUCT DISCONNECT");
                        }
                        @Override
                        public void onProductConnect(BaseProduct baseProduct) {
                            ...
                            isRegistrationInProgress.set(false);
                            if (baseProduct != null) {
                                MApplication.updateProduct(baseProduct);
                            }
                            Log.v(TAG,"REGISTER PRODUCT CONNECT: " + baseProduct.toString());
                        }
                        @Override
                        public void onComponentChange(BaseProduct.ComponentKey componentKey,
                            ...
                            notifyStatusChange();
                            Log.v(TAG,"REGISTER COMPONENT CHANGE: " + componentKey + " / " + oldComponent + " / " + newComponent);
                        }
                    });
                }
            });
        ...
        UserAccountManager.getInstance().logIntoDJIUserAccount(this,
                new CommonCallbacks.CompletionCallbackWith<UserAccountState>() {
                    ...
                    public void onFailure(DJIError error) {
                        showToast("Failed to log in: " + error.getDescription());
                    }
                });
    ...
    private void updateTitleBar() {
        ...
        if (product != null) {
            if (product.isConnected()) {
                ...
                showToast(MApplication.getProductInstance().getModel() + " Connected");
                ret = true;
            } else {
    ...
    private void updateVersion() {
        ...
        if (MApplication.getProductInstance() != null) {
            final String version = MApplication.getProductInstance().getFirmwarePackageVersion();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_open: {
                Intent intent = new Intent(this, DJIfrontEnd.class);
